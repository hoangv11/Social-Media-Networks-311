...
# Add more methods as needed for actions like getting connections by type, etc.
...
class Post:
    def __init__(self, creator, content, responding_to=None, time_and_date=None, seen_by=[]):
        ...
        self.seen_by = seen_by       # List of User objects who have seen the post
